package com.medibook.payment.filter;
...
class InternalRequestFilterTest {
    ...
    @Test
    void doFilterInternal_validSecret_continues() throws Exception {
    ...
    @Test
    void doFilterInternal_swaggerPath_continues() throws Exception {
